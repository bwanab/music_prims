defmodule ArpeggioTest do
  ...
  describe "lots of manipulations test" do
    test "returns correct sonarities" do
      ...
      assert everything == [
        %Note{channel: 0, duration: 0.5, note: :C, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :C, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :E, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :G, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :A, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :C, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :A, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :E, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :G, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :B, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :E, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 0.5, note: :G, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :C, octave: 2, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :C, octave: 3, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :A, octave: 2, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :C, octave: 3, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :E, octave: 2, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 1, note: :B, octave: 2, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :C, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :G, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :C, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :G, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :A, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :C, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :A, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :C, octave: 6, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 6, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :G, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :B, octave: 4, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :E, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :G, octave: 5, staccato: false, velocity: 100},
        %Note{channel: 0, duration: 2, note: :B, octave: 5, staccato: false, velocity: 100}
      ]
    end
  end
end
